...
CLOUD = os.environ.get("USE_AZURE_CREDENTIAL", "false").lower() == "true" #envissä oltava true jos haluu pilveen

# Having any of these missign should raise an exception
STORAGE_CONTAINER = os.environ["STORAGE_CONTAINER"]  # Blob säiliön nimi
STORAGE_QUEUE = os.environ["STORAGE_QUEUE"] # Jonon nimi
...
def get_blob_service_client():
    ...
    """
    if CLOUD: #jos toimitaan pilvessä
...
def container_exists(client: BlobServiceClient, container_name: str): # tarkistaa resurssien olemassaolon
